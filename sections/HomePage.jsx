      ...
      <div className="container mx-auto w-full h-full">
        <div className="flex flex-col lg:flex-row items-center gap-5 lg:gap-16 justify-center md:justify-between w-full h-full">
          <div className="flex flex-col gap-5 lg:w-[70rem]">
            <h3 className="text-[30px] lg:text-[70px] text-justify lg:text-start leading-[2.5rem] lg:leading-[4.5rem] font-semibold"><span>Meetos:</span> Where tech lovers unite, sparking innovation in shared passion</h3>
            <p className="text-[18px] lg:text-[24px] text-justify">Networking at in-person meetups can be challenging. Our solution provides a list of registered attendees nearby, allowing for easy access to their professional social profiles for improved connections</p>
