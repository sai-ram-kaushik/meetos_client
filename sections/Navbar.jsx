      ...
      <div className="container mx-auto w-full h-full">
        <div className="flex items-center justify-between w-full h-full px-4 lg:px-0">
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <Link href="/login"><button className="bg-secondary lg:w-[10rem] p-3 rounded-lg text-xl text-background hover:bg-background hover:text-primary border border-secondary duration-200 font-bold ease-in-out">Login</button></Link>
          </div>
          ...
          <div
            ...
            <Link href="/" onClick={handleChange}>
              <h1 className="text-background">Meet<span>Os</span></h1>
            </Link>
            <div className="flex flex-col items-center justify-center w-full h-full gap-10">
              ...
              <Link href="/login"> <button className="bg-secondary text-background lg:w-[10rem] p-3 rounded-lg text-xl hover:bg-background hover:text-primary border border-secondary duration-200" onClick={handleChange}>Login</button></Link>
